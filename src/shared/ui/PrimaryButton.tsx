...
const PrimaryButton: React.FC<Props> = ({ className, children, onClick, loading, disabled, type = "button" }) => {
	return (
		<button
			type={type}
			onClick={onClick}
			disabled={loading || disabled}
			className={`cursor-pointer h-10 max-w-45 w-full p-2.5 rounded-[8px] bg-primary-gradient text-10 leading-100 text-white font-medium transition-all duration-300 
