...
const CommonPhoneInput = <T extends FieldValues>({ control, name, label, error, placeholder, className }: Props<T>) => {
	return (
				...
				<Controller
					...
					render={({ field: { onChange, value } }) => (
						<PhoneInput
							...
							inputClass={`!w-full !h-11 !border-t-0 !border-x-0 !border-b !border-[#E6E6E6] !bg-transparent !pl-[48px] !pr-4 !py-3 !text-sm md:!text-base !text-black-primary !placeholder-[#9E9E9E] !outline-none !rounded-none focus:!border-black-primary !transition-colors ${
